...
public class ExampleButtons extends BaseTest {
    ...
    public void setUp() {
        ...
        LoggerUtil.info("Setting up Buttons test");
    }
    ...
    public void testButtonsPageLoads() {
        ...
        Assert.assertTrue(buttonsPage.isPageLoaded(), "Buttons page should load successfully");
        
        // Verify page title and heading
        String expectedTitle = "DEMOQA";
        String actualTitle = buttonsPage.getPageTitle();
        Assert.assertTrue(actualTitle.contains(expectedTitle), 
            "Page title should contain '" + expectedTitle + "', but was '" + actualTitle + "'");
        
        String expectedHeading = "Buttons";
        String actualHeading = buttonsPage.getPageHeading();
