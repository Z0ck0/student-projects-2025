...
public class ExampleButtons extends BaseTest {
    ...
    // Disable auto-navigation to base URL since we want to navigate to specific pages
//    public ExampleButtons() {
//        super();
//        setAutoNavigateToBaseUrl(false);
//    }
    
    /**
     * Navigate to Buttons page before each test method
     * This ensures the page is ready for each test
     */
    @BeforeMethod
    public void navigateToButtonsPage() {
        LoggerUtil.info("=== Setting up Buttons page for test ===");
        pages.navigateToButtonsPage();
        LoggerUtil.info("Successfully navigated to Buttons page");
    }
    ...
    public void testButtonsPageLoads() {
        ...
        // Page is already navigated to Buttons page via @BeforeClass
    ...
    public void testAllButtonsPresent() {
        ...
        Assert.assertTrue(pages.getButtonsPage().verifyAllButtonsPresent(), 
            "All buttons should be present on the page");
        
        // Individual button verification with enhanced logging
        boolean doubleClickButtonPresent = pages.getButtonsPage().isDoubleClickButtonDisplayed();
        boolean rightClickButtonPresent = pages.getButtonsPage().isRightClickButtonDisplayed();
        boolean clickMeButtonPresent = pages.getButtonsPage().isClickMeButtonDisplayed();
    ...
    public void testDoubleClickFunctionality() {
        ...
        Assert.assertTrue(pages.getButtonsPage().isPageLoaded(), "Page should be loaded");
        ...
        pages.getButtonsPage().performDoubleClick();
        
        // Wait for and verify the result message
        pages.getButtonsPage().waitForDoubleClickMessage();
        Assert.assertTrue(pages.getButtonsPage().isDoubleClickMessageDisplayed(), 
            "Double click message should be displayed");
        
        String message = pages.getButtonsPage().getDoubleClickMessage();
    ...
    public void testRightClickFunctionality() {
        ...
        // Perform right click
        pages.getButtonsPage().performRightClick();
        
        // Wait for and verify the result message
        pages.getButtonsPage().waitForRightClickMessage();
        Assert.assertTrue(pages.getButtonsPage().isRightClickMessageDisplayed(), 
            "Right click message should be displayed");
        
        String message = pages.getButtonsPage().getRightClickMessage();
    ...
    public void testSingleClickFunctionality() {
        ...
        pages.getButtonsPage().performSingleClick();
        
        // Wait for and verify the result message
        pages.getButtonsPage().waitForDynamicClickMessage();
        Assert.assertTrue(pages.getButtonsPage().isDynamicClickMessageDisplayed(), 
            "Dynamic click message should be displayed");
        
        String message = pages.getButtonsPage().getDynamicClickMessage();
    ...
    public void testAllButtonInteractions() {
        ...
        boolean allInteractionsSuccessful = pages.getButtonsPage().performAllButtonInteractions();
        ...
        Assert.assertTrue(pages.getButtonsPage().verifyAllMessagesDisplayed(), 
            "All result messages should be displayed after interactions");
        
        // Verify individual messages
        String doubleClickMessage = pages.getButtonsPage().getDoubleClickMessage();
        String rightClickMessage = pages.getButtonsPage().getRightClickMessage();
        String dynamicClickMessage = pages.getButtonsPage().getDynamicClickMessage();
    ...
    public void testPageNavigation() {
        ...
        // Verify current URL
        String currentUrl = pages.getButtonsPage().getPageUrl();
        String expectedUrl = "https://demoqa.com/buttons";
        Assert.assertEquals(currentUrl, expectedUrl, 
            "Current URL should match expected URL");
        
        // Verify page is loaded
        Assert.assertTrue(pages.getButtonsPage().isPageLoaded(), "Page should be loaded after navigation");
    ...
    public void testPageContent() {
        ...
        String bodyText = pages.getButtonsPage().getPageBodyText();
    ...
    public void testButtonsWithDataProvider(String testName, String expectedResult) {
        ...
        switch (testName.toLowerCase()) {
            ...
            case "single click":
                pages.getButtonsPage().performSingleClick();
                pages.getButtonsPage().waitForDynamicClickMessage();
                String singleClickMessage = pages.getButtonsPage().getDynamicClickMessage();
    ...
    // @Severity(SeverityLevel.MINOR)
    // public void testBrowserTypeHandling() {
    ...
    //     try {
    //         BrowserType browserType = BrowserType.fromString(ConfigReader.getDefaultBrowser());
    //         LoggerUtil.info("Parsed Browser Type: " + browserType.name());
    //         LoggerUtil.info("Browser Value: " + browserType.getValue());
    //     } catch (IllegalArgumentException e) {
    //         LoggerUtil.warning("Invalid browser type in config: " + ConfigReader.getDefaultBrowser());
    //         // Use default browser
    ...
    //     // Navigate to the Buttons page
    //     pages.getButtonsPage().navigateToButtonsPage();
    ...
    //     if (ConfigReader.isScreenshotEnabled()) {
    //         String screenshotPath = ScreenshotUtils.takeScreenshot(driver, "browser-handling-" + ConfigReader.getDefaultBrowser());
